      ...
      if (this.props?.processed) {
        ...
        getPointCards(this.api, this.props.point_id, '', this.searchParams).subscribe(({branches, selectedCard, cardBranch}) => {
          ...
          branches.forEach(branch => {
            ...
            this.multiProps.full_title = branch.cards[0].branch_operating_unit || branch.cards[0].organization_name_parts?.primary || branch.cards[0].organization_short_name || branch.cards[0].organization_name;
          });
